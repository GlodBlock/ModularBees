...
public abstract class MBRecipeCategory<R extends Recipe<@NotNull RecipeInput>> extends AbstractRecipeCategory<@NotNull RecipeHolder<@NotNull R>> {

    protected IDrawable background;

    public MBRecipeCategory(IGuiHelper helpers, IRecipeType<@NotNull RecipeHolder<@NotNull R>> recipeType, ItemLike icon, int width, int height) {
        this(helpers, recipeType, new ItemStack(icon), width, height);
    }

    public MBRecipeCategory(IGuiHelper helpers, IRecipeType<@NotNull RecipeHolder<@NotNull R>> recipeType, ItemStack icon, int width, int height) {
        super(
                recipeType,
                icon.getHoverName(),
