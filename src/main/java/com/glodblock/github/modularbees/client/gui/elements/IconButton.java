...
public class IconButton extends Button implements RelativePosition, Resizable, TooltipElement {
    ...
    public void addAction(PicData icon, Runnable onPress, List<Component> tooltip) {
        this.actions.add(new ActionPair(icon, _ -> onPress.run(), tooltip));
    }
    ...
    @Override
    public void extractContents(@NotNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partial) {
