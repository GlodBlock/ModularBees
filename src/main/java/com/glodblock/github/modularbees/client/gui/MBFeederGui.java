...
public class MBFeederGui extends MBBaseGui<ContainerMBFeeder> {

    private static final PicData BG = PicData.of(ModularBees.id("textures/gui/feeder.png")).select(0, 0, 176, 166);

    public MBFeederGui(ContainerMBFeeder container, Inventory inv, Component component) {
