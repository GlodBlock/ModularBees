...
public class BlockCentrifugeExport extends BlockMBTileBase<TileCentrifugeExport> implements ConnectBlock, Centrifuge {

    public BlockCentrifugeExport(BlockBehaviour.Properties properties) {
