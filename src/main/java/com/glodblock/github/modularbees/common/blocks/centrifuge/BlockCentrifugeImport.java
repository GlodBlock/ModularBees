...
public class BlockCentrifugeImport extends BlockMBGuiBase<TileCentrifugeImport> implements ConnectBlock, Centrifuge {

    public BlockCentrifugeImport(BlockBehaviour.Properties properties) {
    ...
    @Override
    public void openGui(TileCentrifugeImport tile, Player p) {
        MBGuiHandler.open(ContainerMBImport.TYPE.type(), p, ContainerResolver.of(tile));
    }
